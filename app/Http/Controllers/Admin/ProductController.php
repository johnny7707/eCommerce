...
class ProductController extends Controller
{
    ...
    {
    	$subcate = DB::table('subcategories')->where('category_id',$category_id)->get();
    ...
    public function store(Request $request)
    {
    	...
    	if ($image_one && $image_two && $image_three) {
    		...
    		$notification = array(
                       'messege'=>'Product Created Successfully', 'alert-type'=>'success');
    ...
    public function inactive($id)
    {
    	...
    	$notification = array(
                       'messege'=>'Product Successfully Inactive', 'alert-type'=>'success');
     ...
     public function active($id)
    {
    	...
    	$notification = array(
                       'messege'=>'Product Successfully Active', 'alert-type'=>'success');
            return Redirect()->back()->with($notification);
    }
    ...
    public function DeleteProduct($id)
    {
    	...
    	$notification = array(
                       'messege'=>'Product Successfully Deleted', 'alert-type'=>'success');
            return Redirect()->back()->with($notification);
    }

    public function ViewProduct($id)
    {
    	//echo " Product Preview!..Here."; //Testing
    ...
    public function UpdateProductWithoutPhoto(Request $request,$id)
    {
    	...
    	if ($update) {
    		$notification = array(
                       'messege'=>'Product Successfully Updated', 'alert-type'=>'success');
            return Redirect()->route('list.product')->with($notification);
    	}else{
    		$notification = array(
                       'messege'=>'Nothing to Updated', 'alert-type'=>'success');
            return Redirect()->route('list.product')->with($notification);
    	}
    ...
    public function UpdateProductPhoto(Request $request,$id)
    {
    	...
    	if ($image_one) {
    		...
    		$notification = array(
                       'messege'=>'Image One Updated Successfully', 'alert-type'=>'success');
    	...
    	if ($image_two) {
    		...
    		$notification = array(
                       'messege'=>'Image Two Updated Successfully', 'alert-type'=>'success');
    	...
    	if ($image_three) {
    		...
    		$notification = array(
                       'messege'=>'Image Three Updated Successfully', 'alert-type'=>'success');
