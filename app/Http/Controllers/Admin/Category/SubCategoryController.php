...
class SubCategoryController extends Controller
{
    ...
    public function storesubcat(Request $request)
    {
    	...
    	$notification = array(
                       'messege'=>'Sub Category added successfully', 'alert-type'=>'success');
    ...
    public function DeleteSubcategory($id)
    {
    	DB::table('subcategories')->where('id',$id)->delete();
			    	...
			    	$notification = array(
                       'messege'=>'Sub Category Deleted successfully', 'alert-type'=>'success');
    ...
    public function UpdateSubcategory(Request $request, $id)
    {
    	...
    	$notification = array(
                       'messege'=>'Sub Category Updated successfully', 'alert-type'=>'success');
