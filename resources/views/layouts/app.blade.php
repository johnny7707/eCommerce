...
<html lang="en">
<head>
<title>A&J Shopping</title>
<meta charset="utf-8">
<meta http-equiv="X-UA-Compatible" content="IE=edge">
<meta name="description" content="A&J Shopping">
<meta name="viewport" content="width=device-width, initial-scale=1">
<link rel="icon" href="{{ asset('public/frontend/icons/favicon.png')}}" type="image/png" sizes="32x32">
                ...
                <div class="row">
                    <div class="col d-flex flex-row">
                        <div class="top_bar_contact_item"><div class="top_bar_icon">
                            <img src="{{ asset('public/frontend/images/phone.png') }}" alt=""></div>+66 065 690 4991</div>
                        <div class="top_bar_contact_item"><div class="top_bar_icon">
                            <img src="{{ asset('public/frontend/images/mail.png') }}" alt=""></div>
                            <a href="mailto:jiva8899@gmail.com">jiva8899@gmail.com</a>
                        </div>
                        <div class="top_bar_content ml-auto">
                            <div class="top_bar_menu">
                                <ul class="standard_dropdown top_bar_dropdown">
                                    ...
                                    <li>
                                        <a href="#"> &#3647; Thai Bath<i class="fas fa-chevron-down"></i></a>
                                        <ul>
                                            <li><a href="#"> &dollar; USD Dollar</a></li>
                                            <li><a href="#"> &euro; EUR Euro</a></li>
                                            <li><a href="#"> &#8356; GBP British Pound</a></li>
                                            <li><a href="#"> &yen; JPY Japanese Yen</a></li>
                                            <li><a href="#"> &#3647;  Bath Thai</a></li>
                                        </ul>
                                    </li>
                                </ul>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-2 col-sm-3 col-3 order-1">
                        <div class="logo_container">
                            <div class="logo"><a href="{{ url('/') }}"> <img src="{{ asset('public/frontend/images/Logo_A_J.png') }}" alt="">  </a></div>
                        </div>
                    </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3 footer_col">
                    <div class="footer_column footer_contact">
                        ...
                        <div class="footer_phone">+66 065 690 4991</div>
                        <div class="footer_contact_text">
                            <p>23/7 Klorng Sam, Klorng Laung </p>
