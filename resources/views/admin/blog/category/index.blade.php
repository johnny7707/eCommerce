    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Langauge Category List 
          	<a href="" class="btn btn-sm btn-success" style="float: right;" data-toggle="modal" data-target="#modaldemo3"> 
          		<i class="fa fa-plus-circle fa-lg" area-hidden="true"></i>  New Category </a></h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p"> English</th>
                  <th class="wd-15p"> Thai</th>
              ...
              @foreach($blogcat as $key=>$row)
                <tr>
                  ...
                  <td> {{ $row->category_name_th }} </td>
                  <td>
                  	<a href="{{ URL::to('edit/blogcategory/'.$row->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit" aria-hidden="true"></i></a>
                  	<a href=" {{ URL::to('delete/blogcategory/'.$row->id) }} " class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  </td>
                </tr>
              @endforeach
              </tbody>
	            ...
	            @csrf 
	             <div class="modal-body pd-20">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="category_name_en" aria-describedby="emailHelp" placeholder="English" name="category_name_en">
					</div>
          <div class="form-group">
            <label for="exampleInputEmail1">Category Name Thai</label>
            <input type="text" class="form-control" id="category_name_th" aria-describedby="emailHelp" placeholder="Thai" name="category_name_th">
          </div>
	             </div><!-- modal-body -->
