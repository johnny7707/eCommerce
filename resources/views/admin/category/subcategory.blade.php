        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Sub Category List 
          	<a href="" class="btn btn-sm btn-success" style="float: right;" data-toggle="modal" data-target="#modaldemo3"> 
          		<i class="fa fa-plus-circle fa-lg" area-hidden="true"></i>  New Sub Category</a></h6>
            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              @foreach($subcat as $key=>$row)
                <tr>
                  ...
                  <td>
                  	<a href="{{ URL::to('edit/subcategory/'.$row->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit" aria-hidden="true"></i></a>
                  	<a href=" {{ URL::to('delete/subcategory/'.$row->id) }} " class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  </td>
                </tr>
              @endforeach
              </tbody>
	 ...
	 <form method="post" action=" {{ route('store.subcategory') }} "> 
	     ...
	     <div class="modal-body pd-20">
					<div class="form-group">
						...
						<input type="text" class="form-control" id="subcategory_name" aria-describedby="emailHelp" placeholder="Sub Category" name="subcategory_name">
					</div>
