            ...
            <table id="datatable1" class="table display responsive nowrap">
              ...
              @foreach($category as $key=>$row)
                <tr>
                  ...
                  <td>
                  	<a href="{{ URL::to('edit/category/'.$row->id) }}" class="btn btn-sm btn-info"><i class="fa fa-edit" aria-hidden="true"></i></a>
                  	<a href=" {{ URL::to('delete/category/'.$row->id) }} " class="btn btn-sm btn-danger" id="delete"><i class="fa fa-trash" aria-hidden="true"></i></a>
                  </td>
                </tr>
              @endforeach
              </tbody>
