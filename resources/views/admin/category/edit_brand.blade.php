    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Brand Update </a></h6>
            ...
            <form method="post" action=" {{ url('update/brand/'.$brand->id) }} " enctype="multipart/form-data"> 
               ...
               <div class="modal-body pd-20">
                ...
                <div class="form-group">
                  ...
                  <input type="file" class="form-control" id="brand_logo" aria-describedby="emailHelp" value="{{ $brand->brand_name }}" name="brand_logo">
                </div>
                <div class="form-group">
                  <label for="exampleInputEmail1">Old Brand Logo</label>
                  <img src="{{ URL::to($brand->brand_logo)  }}" height="80px" width="150px">
