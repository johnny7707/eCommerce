      ...
      <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
          <h6 class="card-body-title">Update Product 
              <a href="{{ route('list.product')}}" class="btn btn-success btn-sm pull-right">
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="size" name="product_size" data-role="tagsinput" value="{{ $product->product_size }}"  />
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="color" name="product_color" data-role="tagsinput" value="{{ $product->product_color }}"  />
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="color" name="selling_price"value="{{ $product->selling_price }}"  />
                </div>
              </div><!-- col-4 -->

              <div class="col-lg-8">
                <div class="form-group">
                  <label class="form-control-label">Product Detials: <span class="tx-danger">*</span></label>
...
<hr>
            ...
            <div class="form-layout-footer">
              <button class="btn btn-purple mg-r-5 pull-right">Update Product</button>
        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <div class="row">
              <div class="col-lg-6 col-sm-6">
                ...
                <div class="col-lg-6 col-sm-6">
                  <img src="{{ URL::to($product->image_one)}}" style="width: 100px; height: 100px;">
                </div>
              <!-- col-4 -->
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="col-lg-6 col-sm-6">
                  <img src="{{ URL::to($product->image_two)}}" style="width: 100px; height: 100px;">
                </div>
            ...
            <div class="col-lg-6 col-sm-6">
              ...
              <div class="col-lg-6 col-sm-6">
                  <img src="{{ URL::to($product->image_three)}}" style="width: 100px; height: 100px;">
                </div>
              <!-- col-4 -->
