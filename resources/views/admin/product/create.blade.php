    ...
    <div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        <div class="card pd-20 pd-sm-40">
          ...
          <p class="mg-b-20 mg-sm-b-30"> New product will be created here.</p>
            ...
            <div class="row mg-b-25">
              ...
              <div class="col-lg-3">
               ...
               <div class="col-lg-3">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="color" name="selling_price" placeholder="Selling Price" required=""  />
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="size" name="product_size" value="" data-role="tagsinput"  />
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="color" name="product_color" value="" data-role="tagsinput"  />
                </div>
              </div><!-- col-4 -->
...
<hr>
            ...
            <div class="form-layout-footer">
              <button class="btn btn-info mg-r-5">Create New Product</button>
