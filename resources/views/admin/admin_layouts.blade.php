...
<html lang="en">
  <head>
    ...
    <!-- Twitter -->
    <meta name="twitter:site" content="@aandj">
    <meta name="twitter:creator" content="@aandj">
    <meta name="twitter:card" content="summary_large_image">
    <meta name="twitter:title" content="AandJ Shopping">
    <meta name="twitter:description" content="Shopping Online ">
    <meta name="twitter:image" content="Shopping Online">

    <!-- Facebook -->
    <meta property="og:url" content="Shopping Online">
    ...
    <meta name="author" content="Shopping Online">

    <title>A&J Shopping | Admin </title>
    <link rel="icon" href="{{ asset('public/backend/img/favicon.png')}}" type="image/png" sizes="32x32">
    <!-- vendor css -->
        ...
        <nav class="nav">
          <div class="dropdown">
            <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
              <span class="logged-name"> Suchada <span class="hidden-md-down"> Rayain </span></span>
              <img src=" {{ asset('public/backend/img/ant1.jpg') }} " class="wd-32 rounded-circle" alt="">
            </a>
