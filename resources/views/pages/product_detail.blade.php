						...
						<div class="row">
							<div class="col-lg-4">
								<div class="form-group">
									...
									<select class="form-control form-control-lg" id="exampleFormControlSelect1" name="color">
				...
				@else
							<div class="col-lg-4">
								<div class="form-group">
									...
									<select class="form-control form-control-lg" id="exampleFormControlSelect1" name="size">
				...
				@endif
							...
							<div class="col-lg-4">
								<div class="form-group">
									...
									<input type="number" class="form-control form-control-lg" value="1" pattern="[0-9]" name="qty">
								</div>
							</div>
