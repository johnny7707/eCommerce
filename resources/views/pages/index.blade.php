                        ...
                        <div class="tabbed_container">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                <a href="{{ url('product/details/'.$row->id.'/'.$row->product_name) }}">
                                                    <img src="{{ asset($row->image_one) }}" alt="" style="width: 150px; height: 150px;">
                                                </a>
                                            </div>
                            ...
                            @foreach($trend as $row)
                                    <div class="featured_slider_item">
                                        ...
                                        <div class="product_item discount d-flex flex-column align-items-center justify-content-center text-center">
                                            <div class="product_image d-flex flex-column align-items-center justify-content-center">
                                                <img src="{{ asset($row->image_one) }}" alt="" style="width: 150px; height: 150px;"></div>
                                            <div class="product_content">
                                                <div class="product_price discount">
                                                    @if($row->discount_price == NULL)
                                                    <h2>&#3647; {{ $row->selling_price }}</h2>
...
@endphp
    ...
    @php
            $mid = DB::table('products')
                    ...
                    ->where('products.mid_slider',1)->orderBy('id','desc')->limit(5)
                    ->get();
    @endphp
                            ...
                            <div class="row fill_height">
                                ...
                                <div class="col-lg-8 col-md-6 fill_height">
                                    <div class="banner_2_image_container">
                                        <div class="banner_2_image"><img src="{{ asset($row->image_one) }}" alt="" style="width: 600px; height: 500px;"></div>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="trends_container">
                        <h2 class="trends_title">Buy One Get One Product</h2>
...
@php
        $buyget = DB::table('products')
                    ->join('brands','products.brand_id','brands.id')
                    ->select('products.*','brands.brand_name')
                    ->where('status',1)->where('buyone_getone',1)->orderBy('id','DESC')->limit(8)->get();
@endphp
                <!-- Trends Slider -->
                <div class="col-lg-9">
                        ...
                        @foreach($buyget as $row)
                            ...
                            <div class="owl-item">
                                <div class="trends_item is_new">
                                    ...
                                    <a href="" class="btn btn-danger btn-sm addcart" data-id="{{$row->id}}">Add to Card</a>
