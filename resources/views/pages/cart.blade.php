			...
			<div class="row">
				<div class="col-lg-12">
					<div class="cart_container">
						<div class="cart_title">Product order details</div>
						<div class="cart_items">
							<ul class="cart_list">
								@foreach($cart as $row)
								<li class="cart_item clearfix">
									<div class="cart_item_image text-center"><br>
										<img src="{{ asset($row->options->image) }}" alt="" style="width: 80px; height: 80px;"></div>
									<div class="cart_item_info d-flex flex-md-row flex-column justify-content-between">
										<div class="cart_item_name cart_info_col">
											<div class="cart_item_title">{{ $row->name }}</div>
										...
										<div class="cart_item_total cart_info_col">
											...
											<a href="{{ url('remove/cart/'.$row->rowId) }}" class="btn btn-sm btn-danger">
						...
						<div class="cart_buttons">
							<button type="submit" class="button cart_button_clear">Cancel</button>
